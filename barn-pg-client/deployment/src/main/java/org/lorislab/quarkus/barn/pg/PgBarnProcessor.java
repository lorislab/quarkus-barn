 ...
 */
package org.lorislab.quarkus.barn.pg;
...
import org.lorislab.quarkus.barn.BarnPoolBuildItem;

public class PgBarnProcessor {
    ...
    ServiceStartBuildItem configureRuntimeProperties(PgPoolBuildItem pgPoolBuildItem, BuildProducer<BarnPoolBuildItem> pool) {
        pool.produce(new BarnPoolBuildItem("postgresql", PgPool.class));
